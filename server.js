...
app.use("/garage", require("./router/garage"));
app.use("/atelier", require("./router/atelier"));
app.use("/employe", require("./router/employe"));
app.use("/voiture", require("./router/voiture"));
app.use("/marque", require("./router/marque"));
app.use("/modele", require("./router/modele"));
